        ...
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          ...
          {currentUser ? (
            <div className="float-left" >
                <Link to={"/profiletry"} tryclassName="nav-link">
                  <div style={divStyle} >{currentUser.username}</div>
                </Link>
                <div className="float-left">
                <a href="/app" className="nav-link" onClick={this.logOut}>
                <div class="b" style={divStyle}>LogOut</div>
                </a>
                </div>
            </div>
          ) : (
